                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Редактирование записи') }}</h3>
                            </div>
                    ...
                    <div class="card-body">
                        <form id="edit-menu-form" method="post" action="{{ route('cultureDetailsEdit', $item->id) }}"
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('anons') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-anons"
                                           style="display: block; width: 100%;">{{ __('Анонс') }}</label>
                                    <textarea name="anons" class="form-control" placeholder="Анонс"
                                              style="width: 100%;">{{ $item->anons}}</textarea>
                                </div>
                                ...
                                <div class="form-group{{ $errors->has('text') ? ' has-danger' : '' }}">
                                    ...
                                    <textarea name="text" placeholder="Введите текст"
                                              class="editor">{{ $item->text }}</textarea>
                                </div>
                                ...
                                <div class="form-group{{ $errors->has('category') ? ' has-danger' : '' }}">
                                    ...
                                    <select class="form-control" id="select-category" name="category">
                                        @foreach ($categories as $key =>$category)
                                            <option value="{{$key}}"   @if($key == $item->category)  selected   @endif  >{{$category}}</option>
                                        @endforeach
                                    </select>
