@extends('layouts.app', ['title' => __('Добавление новости')])

@section('content')
    @include('users.partials.header', ['title' => __('Добавление новости')])
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Добавление новости') }}</h3>
                            </div>
                    ...
                    <div class="card-body">
                        <form  id="create-menu-form" method="post" action="{{ route('newsCreate') }}" enctype="multipart/form-data"
                              autocomplete="off">
                            @csrf
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('publish_date') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="publish_date" id="input-date"
                                           ...
                                           placeholder="{{ __('Дата публикация') }}" value="{{ old('publish_date') }}"
                                    >
