@extends('layouts.app', ['title' => __('Редактирование пункта меню')])

@section('content')
    @include('users.partials.header', ['title' => __('Редактирование пункта меню')])
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Редактирование пункта меню') }}</h3>
                            </div>
                    ...
                    <div class="card-body">
                        <form  id="edit-menu-form" method="post" action="{{ route('menuEdit', $item->id) }}" enctype="multipart/form-data"
                              autocomplete="off">
                            @csrf
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('custom_name_class') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="custom_name_class" id="input-custom_name_class"
                                           ...
                                           placeholder="{{ __('Дополнительный класс для пункта меню') }}" value="{{ $item->custom_name_class }}"
                                    >
