        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form id="create-menu-form" method="post" action="{{ route('galleryCreate') }}"
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('text') ? ' has-danger' : '' }}">
                                    ...
                                    <textarea name="description" placeholder="Введите текст"
                                              class="editor">{{  old('description')}}</textarea>
