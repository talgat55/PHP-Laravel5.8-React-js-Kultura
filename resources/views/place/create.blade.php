@extends('layouts.app', ['title' => __('Добавление места')])

@section('content')
    @include('users.partials.header', ['title' => __('Добавление места')])
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form  id="create-menu-form" method="post" action="{{ route('placeCreate') }}" enctype="multipart/form-data"
                              autocomplete="off">
                            @csrf
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('address') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="address" id="input-address"
                                           ...
                                           placeholder="{{ __('Адрес') }}" value="{{ old('address') }}"
                                            >
                                ...
                                <div class="form-group{{ $errors->has('phone') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="phone" id="input-phone"
                                           ...
                                           placeholder="{{ __('Телефон') }}" value="{{ old('phone') }}"
                                            >
                                ...
                                <div class="form-group{{ $errors->has('web_site_link') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="web_site_link" id="input-web_site_link"
                                           ...
                                           placeholder="{{ __('Ссылка на веб сайт') }}" value="{{ old('web_site_link') }}"
                                    >
