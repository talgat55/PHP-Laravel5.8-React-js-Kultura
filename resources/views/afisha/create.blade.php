@extends('layouts.app', ['title' => __('Добавление афиши')])

@section('content')
    @include('users.partials.header', ['title' => __('Добавление афиши')])
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Добавление афиши') }}</h3>
                            </div>
                    ...
                    <div class="card-body">
                        <form  id="create-menu-form" method="post" action="{{ route('afishaCreate') }}" enctype="multipart/form-data"
                              autocomplete="off">
                            @csrf
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('age_limit') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="age_limit" id="input-age_limit"
                                           ...
                                           placeholder="{{ __('Ограничения по возрасту') }}" value="{{ old('age_limit') }}"
                                            >
                                ...
                                <div class="form-group{{ $errors->has('duration') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="duration" id="input-duration"
                                           ...
                                           placeholder="{{ __('Продолжительность') }}" value="{{ old('duration') }}"
                                            >
                                ...
                                <div class="form-group{{ $errors->has('date_time_launch') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="date_time_launch" id="input-date"
                                           ...
                                           placeholder="{{ __('Начало') }}" value="{{ old('date_time_launch') }}"
                                    >
